...
public class PercentifierWaveInfo : MonoBehaviour {

	// has a percent (fraction) associated with it, say 50%
	// Touches a number of objects during its lieftime, say it touches 30 blue objects
	// so after it's done it will create ranodmly in its wake  round(50% * 30 ) blue objects
	// or, if it is <100, it will delete n/100 objects that it hit in its wake.
